...
difference() {
    infill_modifier(test_body_size, test_bolt_nut_length, test_weight_layer_thickness);
    translate([0, 0, - test_body_size[1]-eps]) cube([test_body_size[0], test_body_size[0], test_body_size[1]+bearing_width/2+2*eps]);
}
